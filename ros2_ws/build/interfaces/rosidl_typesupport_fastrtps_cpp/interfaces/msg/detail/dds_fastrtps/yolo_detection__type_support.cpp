...
#include "interfaces/msg/detail/yolo_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::YoloDetection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::YoloDetection & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::YoloDetection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::YoloDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::YoloDetection *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_YoloDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, YoloDetection)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_YoloDetection__handle;
}
